...
import cn.com.onlinetool.jt808.bean.up.req.Up0x0704;
 ...
 */
@Slf4j
@JT808Pack(msgId = JT808Constant.UP_LOCATION_BATCH)
public class Up0x0704Handler implements PackHandler {

    @Override
    public BasePacket handle(BasePacket msg, int flowId) {
        Up0x0704 up0x0704 = new Up0x0704(msg.getMsgBody());
        log.info(up0x0704.toString());
