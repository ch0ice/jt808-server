...
public class ByteArrayUtil {
    ...
    /**
     * 从ByteBuf中读出长度为len的byte[]
     *
     * @param bb
     * @param len
     * @return
     */
    public static byte[] readBytes(ByteBuf bb, int len) {
        byte[] b = new byte[len];
        bb.readBytes(b);
        return b;
    }
    ...
    /**
     * 从ByteBuf中读出长度为len的byte字符串
     *
     * @param bb
     * @param len
     * @return
     */
    public static String readStr(ByteBuf bb, int len) {
        return new String(readBytes(bb, len), JT808Constant.DEFAULT_CHARSET);
    }
